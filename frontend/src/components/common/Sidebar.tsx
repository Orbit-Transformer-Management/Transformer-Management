...
const Sidebar = () => {
  ...
  return (
    <>
      {/* FIXED SIDEBAR */}
      <aside
        className={`fixed left-0 top-0 ${widthClass} h-screen
      ...
      >
        ...
        <div className="p-5 border-b border-gray-200 flex flex-col">
          ...
          {!isCollapsed && <div className="mt-5 p-3 bg-gray-100 rounded-lg" />}
        </div>
      ...
      {/* SPACER to reserve layout width next to the fixed sidebar */}
      <div aria-hidden className={`${widthClass} shrink-0`} />
    </>
  );
};
