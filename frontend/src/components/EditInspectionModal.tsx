...
const EditInspectionModal: React.FC<EditInspectionModalProps> = ({ isOpen, onClose, onEditSuccess, inspectionToEdit }) => {
  ...
  // Populate form when modal opens or inspection changes
  useEffect(() => {
    if (inspectionToEdit) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use PATCH method to match your backend @PatchMapping
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm mt-1">Update the inspection details below</p>
                </div>
              </div>
              <button
                onClick={onClose}
